...
$.Class("com.puma.DigestAuthentication", {
 MAX_ATTEMPTS : 1,
 ...
 setCredentials: function(username, password){
   ...
   this.settings.password = hex_md5(password);
   return;
 },
 call : function(uri){
   this.attempts = 0;
 ...
 invokeCall: function(uri,authorizationHeader){
   ...
   $.ajax({
         ...
         error: function(response) { 
          ...
          var paramParser = new com.puma.HeaderParamsParser(response.getResponseHeader(digestAuth.WWW_AUTHENTICATE_HEADER));
...
$.Class("com.puma.HeaderParamsParser",{
